...
def plot_vary_parameters(dict_vary, dict_vary_b1, dict_vary_b2, show=True,
    ...
    plt.plot(x_axis, max_consensus_mean, linewidth=2, label='Normal B.')
    ...
    plt.plot(x_axis, n_consensus_mean, linewidth=2, label='Normal B.')
    ...
    plt.figure()
    plt.title('% of Transactions in consensus varying {}'.format(vary_dimension), fontsize=20)
    plt.plot(x_axis, transactions_p_mean, 'firebrick', linewidth=2, label='Normal B.')
